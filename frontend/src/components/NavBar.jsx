...
const colorCombos = [
  { text: 'text-orange-400', from: 'from-orange-900/30', shadow: 'shadow-[0_0_16px_2px_rgba(255,140,0,0.2)]' },
  { text: 'text-blue-400', from: 'from-blue-900/30', shadow: 'shadow-[0_0_16px_2px_rgba(59,130,246,0.2)]' },
  { text: 'text-green-400', from: 'from-green-900/30', shadow: 'shadow-[0_0_16px_2px_rgba(34,197,94,0.2)]' },
  { text: 'text-purple-400', from: 'from-purple-900/30', shadow: 'shadow-[0_0_16px_2px_rgba(168,85,247,0.2)]' },
  { text: 'text-pink-400', from: 'from-pink-900/30', shadow: 'shadow-[0_0_16px_2px_rgba(236,72,153,0.2)]' },
];
      ...
      {navItems.map(({ to, label, icon }) => (
        <NavLink
          ...
          className={({ isActive }) =>
            ...
            (isActive ? activeClassRef.current : 'text-white hover:text-orange-300')
          }
          end={to === '/'}
        >
